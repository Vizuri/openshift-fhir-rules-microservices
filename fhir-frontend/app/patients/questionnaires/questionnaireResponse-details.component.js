...
var QuestionnaireResponseDetailComponent = (function () {
    function QuestionnaireResponseDetailComponent(_route, _router, fhirService, _location) {
        this._route = _route;
    ...
    QuestionnaireResponseDetailComponent.prototype.ngOnInit = function () {
        ...
        this.fhirService.getOneFhirObject('/' + this.id, environment_1.environment.apiUrl_questionnaireResponse)
            .subscribe(function (questionnaireResponse) { return _this.fhirObject = questionnaireResponse; }, function (error) { return _this.errorMessage = error; });
    };
...
//# sourceMappingURL=questionnaireResponse-details.component.js.map