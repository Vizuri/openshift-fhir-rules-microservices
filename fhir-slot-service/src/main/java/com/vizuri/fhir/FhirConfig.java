...
public class FhirConfig {
	...
	public CustomConversions customConversions(ObjectMapper objectMapper){
		...
		converters.add(new AbstractMongoConverter<DBObject, Slot>() {
			@Override
			public Slot convert(DBObject dbObject) {
				return (Slot)super.convertToResource(objectMapper, dbObject, Slot.class);
			}			
		});
		
		converters.add(new AbstractMongoConverter<Slot, DBObject>(){
			@Override
			public DBObject convert(Slot slot) {
				return super.convertToDBObject(objectMapper, slot);
			}			
		});		
	...
	public ObjectMapper objectMapper(ResourceSerializer resourceSerializer, ResourceDeserializer resourceDeserializer) {
		...
		module.addSerializer(Slot.class, resourceSerializer);
		module.addDeserializer(Slot.class, new JsonDeserializer<Slot>() {

			@Override
			public Slot deserialize(JsonParser parser, DeserializationContext context)
					throws IOException, JsonProcessingException {
				return (Slot) resourceDeserializer.deserialize(parser, context);
			}			
		});
